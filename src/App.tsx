...
import { FileText, Play, Code, CheckCircle, Lightbulb, Info, BookOpen, UserCheck, HelpCircle } from 'lucide-react';
          ...
          <div className="bg-slate-100 rounded-xl p-5 border border-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
              ...
              <div className="bg-white p-3.5 rounded-lg border border-slate-200 shadow-xs">
                ...
                <p className="text-slate-500 leading-relaxed">
                  Permet la validation instantanée côté client. On accède aux valeurs saisies via le chemin d'accès d'élément parent : <code className="bg-slate-100 font-mono text-[10.5px] px-0.8 py-0.2 rounded text-red-650 font-semibold">Formulaire.NomDuChamp.value</code>.
                </p>
              </div>
            </div>
